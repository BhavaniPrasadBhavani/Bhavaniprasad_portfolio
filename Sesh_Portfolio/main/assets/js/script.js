...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Kasireddy Seshi Reddy";
...
var typed = new Typed(".typing-text", {
    strings: ["Playing with data", "Data Cleaning", "Data Analysis", "Data Visualization", "Data Prediction", "Development"],
    loop: true,
    typeSpeed: 60,
    backSpeed: 30,
    backDelay: 500,
...
async function getData(type = "skills") {
    let response
    type === "skills" ?
        response = await fetch("skills.json")
        :
...
function showCertificates(certificates) {
    let certificatesContainer = document.querySelector("#cert .box-container");
    let certificateHTML = "";
...
getData("certificates").then(data => {
